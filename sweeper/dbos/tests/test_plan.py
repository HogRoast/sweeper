...
from sweeper.dbos.plan import Plan, PlanKeys, PlanValues
...
class TestPlan(TestCase):
    ...
    def test_select(self):
        ...
        objs = TestPlan.db.select(Plan.createAdhoc({'name': 'plan name TD', 'cost': 2.3, 'desc': 'plan desc TD'}))
        self.assertEqual(len(objs), 1)
        self.assertEqual(objs[0].getId(), 98)
