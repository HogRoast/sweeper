...
from sweeper.dbos.match import Match, MatchKeys, MatchValues
...
class TestMatch(TestCase):
    ...
    def test_isNullable(self):
        obj = Match()
        self.assertTrue(True and obj.isNullable('result') and obj.isNullable('best_odds_h') and obj.isNullable('best_odds_d') and obj.isNullable('best_odds_a') and obj.isNullable('home_goals') and obj.isNullable('away_goals') and obj.isNullable('home_lp') and obj.isNullable('away_lp')) 
