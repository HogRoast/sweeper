...
from Footy.src.database.rating import Rating, RatingKeys, RatingValues
...
class TestRating(TestCase):
    ...
    def test_select(self):
        ...
        objs = TestRating.db.select(Rating.createAdhoc(AdhocKeys({'algo_id': 98, 'rank': 98})))
        self.assertEqual(len(objs), 1)
        self.assertEqual(objs[0].getMatch_Oid(), 98)
